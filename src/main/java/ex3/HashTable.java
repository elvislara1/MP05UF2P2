...
public class HashTable {
    ...
    public void put(Object key, Object value){
        ...
        //si el hash esta vacio se añade
    ...
    //2r ERROR ---> input > input.esperado
    //TODO add try catch
    public Object get(Object key) {
        int hash = getHash(key);
        //reutizamos el codigo
        try {
            if (entries[hash] != null) {
    ...
    public void drop(Object key) {
        ...
        if (entries[hash] != null) {
            ...
            //comprueba si esta y estara vacio
            if(temp.prev == null && temp.next == null){
                ...
                //comprueba si hay uno antes (uno previo)
                if(temp.prev != null)
                    temp.prev.next = temp.next;                         //esborrem temp, per tant actualitzem el següent de l'anterior
                ITEMS--;
            }
    ...
    private HashEntry findKey(Object key, HashEntry entry) {
